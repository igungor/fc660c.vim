...
call s:HL('Comment', s:palette.grey, s:palette.bg, 'none')
" *Comment         any comment
...
call s:HL('Identifier', s:palette.fg, s:palette.bg, 'none')
" *Identifier      any variable name
"  Function        function name (also: methods for classes)

call s:HL('Statement', s:palette.red, s:palette.bg, 'bold')
...
call s:HL('PreProc', s:palette.fg, s:palette.bg, 'none')
...
call s:HL('Type', s:palette.fg, s:palette.bg, 'none')
" *Type            int, long, char, etc.
"  StorageClass    static, register, volatile, etc.
"  Structure       struct, union, enum, etc.
"  Typedef         a typedef

call s:HL('Special', s:palette.fg, s:palette.bg, 'none')
...
" """"""""""""""""""""""""""""""""""""""""""""""""""""
call s:HL('ColorColumn', s:palette.fg, s:palette.grey, 'none')
"  ColorColumn     used for the columns set with 'colorcolumn'

call s:HL('Cursor', s:palette.bg, s:palette.grey, 'none')
...
call s:HL('IncSearch', s:palette.fg, s:palette.brightyellow, 'bold')
"  IncSearch       'incsearch' highlighting; also used for the text replaced with :s///c"

call s:HL('LineNr', s:palette.grey, s:palette.bg, 'none')
...
"  MoreMsg         |more-prompt| 
"
call s:HL('NonText', s:palette.grey, s:palette.bg, 'none')
...
call s:HL('Search', s:palette.fg, s:palette.brightyellow, 'none')
...
"
call s:HL('TabLine', s:palette.bg, s:palette.grey, 'none')
"  TabLine         tab pages line, not active tab page label

call s:HL('TabLineFill', s:palette.fg, s:palette.grey, 'none')
...
call s:HL('Visual', s:palette.fg, s:palette.yellow, 'none')
"  Visual          Visual mode selection

call s:HL('WarningMsg', s:palette.fg, s:palette.bg, 'bold')
"  WarningMsg      warning messages

call s:HL('WildMenu', s:palette.fg, s:palette.yellow, 'bold')
